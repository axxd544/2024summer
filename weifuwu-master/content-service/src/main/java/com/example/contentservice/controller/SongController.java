...
public class SongController {
    ...
    @GetMapping("/song/deleteByManager")
    ...
    public R undeleteSongByManager(@RequestParam int id, @RequestParam int complainterId, @RequestParam int appealerId) {
        return songService.unDeleteSongByManager(id, complainterId, appealerId);
    }
